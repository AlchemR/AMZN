...
displayEditButtons(review){
  console.log("are we hitting here in review display edit buttons")
  console.log("display edit buttons" ,this.props)
  console.log("display edit buttons" ,review)

  if (this.props.currentUser == review.user_id)
    return <div> <button className="review-edit"> Edit Review</button> <button>Delete Review </button></div>
  else 
  return null
      ...
      return (
        ...
        <div className="review-details-main">
          ...
          <div className="individual-review">
              ...
              <div className="helpful-buttons"> <button className="helpful-button-helpful" > Helpful </button> | <button className="helpful-button-report">report abuse</button> </div>
