    ...
    return (
      <div className="navbar-search">
        ...
        {/* <input type="text" className="navbar-search-input" onChange={() => this.updateSearchInput("query")} /> */}
          <input type="text" className="navbar-search-input" placeholder={"Search name, brand, or Keyword: eg. 'Montior' 'TV' or 'Acer' "} onChange={(e) => this.updateSearchInput(e, "query")} value={this.state.query} />
