...
r10 = Review.create!({ user_id: u14.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[2], review_header: "Good for home office use", review_author: u14.account_fname, rating: 5, review_body: "I bought 2 of these for a dual monitor setup for my home office WFH. So far there have been 0 issues. I plugged them in and they have worked perfectly from the start. I have not used them for gaming but I might buy an additional one for a secondary monitor on my gaming rig to replace the second monitor I currently use. Mine had no dead pixels, no weird lines, they just work. And so far... Working well. I recommend at least for home office use. ", verified_purchase: true })

r11 = Review.create!({ user_id: u15.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[3], review_header: "Great value for the price!", review_author: u15.account_fname, rating: 5, review_body: "The monitors arrived in good condition, and as you can see in the video, I mounted them on the dual-monitor stand that was part of the same order. It's set up a little awkwardly for now, since I am not sure I wanna drill holes in my desk yet. The monitors come with riser screws (I think they are called) in order to facilitate mounting on VESA-compatible monitor arms. The monitors are light, sleek, and seem to work well so far. The picture quality doesn't disappoint! Very good value.   I'll update this review in the near future, after using the products for a few months.", verified_purchase: true })

r12 = Review.create!({ user_id: u16.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[4], review_header: "Nice monitor", review_author: u16.account_fname, rating: 5, review_body: "  Upon opening the box I found a couple nice surprises. First, the instructions were in a nicely sized format, with clear print and illustrations. Easy to read and follow. Secondly, they included a good quality screw driver. Properly sized Philips with a comfortable handle. It's nice when these kinds of details are attended to. The monitor powered up and connected to my laptop flawlessly. I did have difficulty with my laptop with a broken screen. Getting the cursor to the settings icon and navigating thru the process to make this my primary/only monitor. Once that was accomplished the monitor worked flawlessly. I'm not a techie nor a gamer so I won't be using this monitor to it's full capability. ", verified_purchase: true })

r13 = Review.create!({ user_id: u17.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[0], review_header: "Very nice picture quality and very affordable.", review_author: u17.account_fname, rating: 5, review_body: " Best monitor for price I have found. I ordered and received two of these along with a USB-C mini hub for dual monitors on my notebook. I could not be happier. Do not expect big sound from the small speakers however they work well and fill the need. The image quality is fantastic and on par with my other 4k monitors of bigger brands. I must also state that the first two never showed up even though Amazon showed they were delivered and 'handed to a household member'. I was not even home. After a couple of days chatting with AZ on line, they replaced them and they DID show up. Had them for a few months now and I am very pleased. ", verified_purchase: true })
r14 = Review.create!({ user_id: u18.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[1], review_header: "Well packaged and east to setup", review_author: u18.account_fname, rating: 5, review_body: " I purchased this for my son for school since it's currently virtual. The poor kid was hunched over looking at the screen on his Chromebook, so I figured the price of the monitor was going to be a lot less than chronic neck pain. The first thing that struck me about this monitor was how well it was packaged inside its box. I've recently purchased some electronics that were sloppily packaged at the factory. This thing is packed well enough to easily survive transit from the warehouse to my door without the need for additional boxing. The second thing that impressed me was the ease of setup. The monitor has a simple connection to the stand (screwdriver included- I guess some people don't have one already) and came with an HDMI cable. The image looks great, as it should since we're dealing with a digital signal. The speakers are more than sufficient for listening to his classes. The people complaining about the sound quality need to get real. Be realistic for what they are.", verified_purchase: true })
r15 = Review.create!({ user_id: u19.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[0], review_header: "Extremely Pleased", review_author: u19.account_fname, rating: 5, review_body: "  I so love this monitor and its performance that, since 2018, I have purchased 7 of these monitors. 4 were for a home office in NJ and 2 were for a home office in FL for vacations. I gave away the 4 in NJ, prior to moving to FL. Thinking that I still had 4 in FL, I gave 1 of those to my brother for his security system. Upon arrival, I realized I only originally had 2 in FL and now I was left with 1. I struggled with 1 monitor for 4 months. I wouldn't purchase another because the pandemic supply and demand had pushed prices too high for my retirement income and I wanted the monitors to match. I happen to see this one at a discount which brought it into my budget range so I jumped on it. It isn't much more than my 2018 purchases however, the last few I bought for FL all have built-in speakers and 2 HDMI ports. Whaaaat? So very much worth the price and I highly recommend this monitor. The pictures are wonderful. Can't comment on sound since I just found out that they have speakers and haven't used those yet. I can only assume they are basic speakers for video cons. 5 stars and 2 thumbs up from me.", verified_purchase: true })
r16 = Review.create!({ user_id: u20.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[1], review_header: "  Nice monitor ", review_author: u20.account_fname, rating: 5, review_body: "  Upon opening the box I found a couple nice surprises. First, the instructions were in a nicely sized format, with clear print and illustrations. Easy to read and follow. Secondly, they included a good quality screw driver. Properly sized Philips with a comfortable handle. It's nice when these kinds of details are attended to.", verified_purchase: true })
r17 = Review.create!({ user_id: u21.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[2], review_header: " Monitor for Lizards ", review_author: u21.account_fname, rating: 5, review_body: " I bought this for my pet dinosaur and he enjoys it very much, even though he has bad eyesight", verified_purchase: true })
r18 = Review.create!({ user_id: u22.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[3], review_header: " Very nice picture quality and very affordable. ", review_author: u22.account_fname, rating: 5, review_body: "  Best monitor for price I have found. I ordered and received two of these along with a USB-C mini hub for dual monitors on my notebook. I could not be happier. Do not expect big sound from the small speakers however they work well and fill the need. The image quality is fantastic and on par with my other 4k monitors of bigger brands. I must also state that the first two never showed up even though Amazon showed they were delivered and 'handed to a household member'. I was not even home. After a couple of days chatting with AZ on line, they replaced them and they DID show up. Had them for a few months now and I am very pleased.", verified_purchase: true })
r19 = Review.create!({ user_id: u23.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[4],  review_header: " For the price, excellent monitor. ", review_author: u23.account_fname, rating: 5, review_body: "  Picture quality is sharp, has pretty good contrast. I have the 24 size and the native resolution defaults to 1920 x 1080. Pretty good blacks. Pretty good color presets. Overall, I have no major complaints at this point. Its a good size for a home-use, office display and at $100, was a pretty good deal. Would recommend to anyone looking for a good monitor on a budget.", verified_purchase: true })
r20 = Review.create!({ user_id: u24.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[1], review_header: " For the price, excellent monitor. ", review_author: u24.account_fname, rating: 5, review_body: "  Picture quality is sharp, has pretty good contrast. I have the 24 size and the native resolution defaults to 1920 x 1080. Pretty good blacks. Pretty good color presets. Overall, I have no major complaints at this point. Its a good size for a home-use, office display and at $100, was a pretty good deal. Would recommend to anyone looking for a good monitor on a budget.", verified_purchase: true })

r21 = Review.create!({ user_id: u2.id, product_id: p1.id, wordcloud:p1.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r22 = Review.create!({ user_id: u2.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 4, review_body: "Demo user reviews", verified_purchase: true })
r23 = Review.create!({ user_id: u2.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 3, review_body: "Demo user reviews", verified_purchase: true })
r24 = Review.create!({ user_id: u2.id, product_id: p4.id, wordcloud:p4.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 3, review_body: "Demo user reviews", verified_purchase: true })
r25 = Review.create!({ user_id: u2.id, product_id: p5.id, wordcloud:p5.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 2, review_body: "Demo user reviews", verified_purchase: true })
r26 = Review.create!({ user_id: u2.id, product_id: p6.id, wordcloud:p6.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u2.account_fname, rating: 2, review_body: "Demo user reviews", verified_purchase: true })
r27 = Review.create!({ user_id: u2.id, product_id: p7.id, wordcloud:p7.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })
r28 = Review.create!({ user_id: u2.id, product_id: p8.id, wordcloud:p8.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })
r29 = Review.create!({ user_id: u2.id, product_id: p9.id, wordcloud:p9.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 2, review_body: "Demo user reviews", verified_purchase: true })
r30 = Review.create!({ user_id: u2.id, product_id: p10.id, wordcloud:p10.wordcloud_tags[0], review_header: "Demo User review ", review_author: u2.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })

r31 = Review.create!({ user_id: u19.id, product_id: p1.id, wordcloud:p1.wordcloud_tags[0], review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r32 = Review.create!({ user_id: u19.id, product_id: p2.id, wordcloud:p2.wordcloud_tags[0], review_header: "Demo User review ", review_author: u19.account_fname, rating: 3, review_body: "Demo user reviews", verified_purchase: true })
r33 = Review.create!({ user_id: u19.id, product_id: p3.id, wordcloud:p3.wordcloud_tags[0], review_header: "Demo User review ", review_author: u19.account_fname, rating: 2, review_body: "Demo user reviews", verified_purchase: true })
r34 = Review.create!({ user_id: u19.id, product_id: p4.id, wordcloud:p4.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })
r35 = Review.create!({ user_id: u19.id, product_id: p5.id, wordcloud:p5.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })
r36 = Review.create!({ user_id: u19.id, product_id: p6.id, wordcloud:p6.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 1, review_body: "Demo user reviews", verified_purchase: true })
r37 = Review.create!({ user_id: u19.id, product_id: p7.id, wordcloud:p7.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 4, review_body: "Demo user reviews", verified_purchase: true })
r38 = Review.create!({ user_id: u19.id, product_id: p8.id, wordcloud:p8.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r39 = Review.create!({ user_id: u19.id, product_id: p9.id, wordcloud:p9.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r40 = Review.create!({ user_id: u19.id, product_id: p10.id, wordcloud:p10.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r41 = Review.create!({ user_id: u19.id, product_id: p11.id, wordcloud:p11.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r42 = Review.create!({ user_id: u19.id, product_id: p12.id, wordcloud:p12.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r43 = Review.create!({ user_id: u19.id, product_id: p13.id, wordcloud:p13.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r44 = Review.create!({ user_id: u19.id, product_id: p14.id, wordcloud:p14.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r45 = Review.create!({ user_id: u19.id, product_id: p15.id, wordcloud:p15.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
r46 = Review.create!({ user_id: u19.id, product_id: p16.id, wordcloud:p16.wordcloud_tags[0],  review_header: "Demo User review ", review_author: u19.account_fname, rating: 5, review_body: "Demo user reviews", verified_purchase: true })
